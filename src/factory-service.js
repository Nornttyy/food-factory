import { FactoryGame, ITEMS, FOOD_RECIPES, STEP, AREAS } from './factory-core.js?v=0.21.0';
import { canLink } from './factory-links.js?v=0.21.0';
import { worldArea, yardLayout, findPath, shelfApproaches } from './factory-yard.js?v=0.21.0';
