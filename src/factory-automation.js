import { FactoryGame, AREAS, BUILDINGS, makeEntity } from './factory-core.js?v=0.19.0';
import { CafeFactoryGame, COMPACT_AREAS, STAFF_COSTS } from './factory-service.js?v=0.19.0';
