...
const source = ['src/factory-career.js', 'src/factory-links.js', 'src/factory-core.js', 'src/factory-feel.js', 'src/factory-renderer.js', 'src/factory-tutorial.js', 'src/factory-main.js'];
