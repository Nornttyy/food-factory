...
const source = ['src/factory-loading.js', 'src/factory-shop.js', 'src/factory-business.js', 'src/factory-career.js', 'src/factory-links.js', 'src/factory-core.js', 'src/factory-crafting.js', 'src/factory-crafting-view.js', 'src/factory-packing.js', 'src/factory-service.js', 'src/factory-automation.js', 'src/factory-yard.js', 'src/factory-feel.js', 'src/factory-renderer.js', 'src/factory-tutorial.js', 'src/factory-main.js'];
...
const files = ['index.html', '.nojekyll', 'factory.css', 'factory-layout.css', 'factory-menu.css', 'factory-service.css', 'factory-crafting.css', 'manifest.webmanifest', 'public/og.png', ...source,
