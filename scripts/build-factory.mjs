...
const source = ['src/factory-shop.js', 'src/factory-cat-rig.js', 'src/factory-shop-view.js', 'src/factory-business.js', 'src/factory-career.js', 'src/factory-links.js', 'src/factory-core.js', 'src/factory-feel.js', 'src/factory-renderer.js', 'src/factory-tutorial.js', 'src/factory-main.js'];
...
const files = ['index.html', '.nojekyll', 'factory.css', 'factory-layout.css', 'factory-menu.css', 'manifest.webmanifest', 'public/og.png', ...source,
