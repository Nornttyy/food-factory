...
const source = ['src/factory-links.js', 'src/factory-core.js', 'src/factory-feel.js', 'src/factory-renderer.js', 'src/factory-main.js'];
...
const files = ['index.html', '.nojekyll', 'factory.css', 'factory-layout.css', 'manifest.webmanifest', 'public/og.png', ...source,
