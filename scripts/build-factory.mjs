...
const source = ['src/factory-loading.js', 'src/factory-shop.js', 'src/factory-business.js', 'src/factory-career.js', 'src/factory-links.js', 'src/factory-core.js', 'src/factory-crafting.js', 'src/factory-crafting-view.js', 'src/factory-sorting.js', 'src/factory-sorting-view.js', 'src/factory-sushi.js', 'src/factory-sushi-view.js', 'src/factory-kitchen.js', 'src/factory-kitchen-content.js', 'src/factory-kitchen-view.js', 'src/factory-packing.js', 'src/factory-service.js', 'src/factory-automation.js', 'src/factory-yard.js', 'src/factory-feel.js', 'src/factory-renderer.js', 'src/factory-tutorial.js', 'src/factory-main.js'];
...
const sushi = await readFile(resolve(root, 'src/factory-sushi-view.js'), 'utf8');
for (const [, id] of sushi.matchAll(/\$\('([^']+)'\)/g)) if (!ids.has(id)) throw new Error(`Missing sushi UI target: ${id}`);
const files = ['index.html', '.nojekyll', 'factory.css', 'factory-layout.css', 'factory-menu.css', 'factory-service.css', 'factory-crafting.css', 'factory-kitchen.css', 'factory-sorting.css', 'factory-sushi.css', 'manifest.webmanifest', 'public/og.png', 'public/og-cat-sorting-prompt.md', ...source,
  'assets/generated/factory/cream-v1/manifest.json',
  'assets/generated/factory/cream-v1/KITCHEN-PROMPTS.md',
  'assets/generated/factory/cream-v1/SUSHI-PROMPT.md',
